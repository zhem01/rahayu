...
function displayItems(){
    ...
    const friedData= foodItem.filter((item)=>item.category=='fried');
    const curryData= foodItem.filter((item)=>item.category=='curry');
    ...
    friedData.map(item=>{
        ...
        itemPrice.innerText= 'Price : ' + item.price+ 'B';
...
function totalAmount(){
    ...
    document.getElementById('total-price').innerText= 'Total Price :' + sum + 'B';
    document.getElementById('m-total-amount').innerText= 'Total Price : ' + sum + 'B';
}
